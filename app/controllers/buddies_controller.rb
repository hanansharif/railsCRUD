class BuddiesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to buddies_path, status: :see_other, notice: "Buddy was successfully destroyed." }
  ...
  private
    ...
    def set_buddy
      @buddy = Buddy.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def buddy_params
      params.expect(buddy: [ :first_name, :last_name, :email, :phone, :twitter ])
    end
end
